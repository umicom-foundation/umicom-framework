/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/qt6/context_diagnostics_qt6.cpp
 *
 * PURPOSE:
 *   Implement the context diagnostics qt6 behaviour used by its public contract
...
#include "umicom/ui/qt6/context_diagnostics.h"

static const UmiQt6SurfaceDescriptor UMI_QT6_DESCRIPTOR = {
    UMI_QT6_ADAPTER_API_VERSION,
    "qt6.context_diagnostics",
    "Umicom.ContextChannel.Diagnostics",
    "QTreeWidget",
    UMI_QT6_NATIVE_TREE,
 ...
 * client applications.
 */
extern "C" const UmiQt6SurfaceDescriptor *umi_qt6_context_diagnostics_descriptor(void) {
 ...
 */
extern "C" UmiQt6WidgetHandle umi_qt6_context_diagnostics_create(const UmiQt6RenderRequest *request) {
