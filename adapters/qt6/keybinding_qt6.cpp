 ...
 *
 * PURPOSE:
 *   Implement the keybinding qt6 behaviour used by its public contract and
 *   client applications.
 *
...
/*
 * Provide the qt6 keybinding descriptor operation used by this module and its client
 * applications.
 */
...
/*
 * Initialise qt6 keybinding from caller-provided values so later operations receive a
 * known state.
 */
