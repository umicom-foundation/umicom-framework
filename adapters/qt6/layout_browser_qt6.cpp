 ...
 *
 * PURPOSE:
 *   Implement the layout browser qt6 behaviour used by its public contract and
 *   client applications.
 *
...
/*
 * Provide the qt6 layout browser descriptor operation used by this module and its client
 * applications.
 */
...
/*
 * Initialise qt6 layout browser from caller-provided values so later operations receive a
 * known state.
 */
