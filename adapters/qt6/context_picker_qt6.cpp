/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/qt6/context_picker_qt6.cpp
 *
 * PURPOSE:
 *   Implement the context picker qt6 behaviour used by its public contract and
 *   client applications.
 *
 ...
 * applications.
 */
extern "C" const UmiQt6SurfaceDescriptor *umi_qt6_context_picker_descriptor(void) {
 ...
 * known state.
 */
extern "C" UmiQt6WidgetHandle umi_qt6_context_picker_create(const UmiQt6RenderRequest *request) {
