/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/qt6/clipboard_qt6.cpp
 *
 * PURPOSE:
 *   Implement the clipboard qt6 behaviour used by its public contract and client
 *   applications.
 *
 ...
 * applications.
 */
extern "C" const UmiQt6SurfaceDescriptor *umi_qt6_clipboard_descriptor(void) {
 ...
 * state.
 */
extern "C" UmiQt6WidgetHandle umi_qt6_clipboard_create(const UmiQt6RenderRequest *request) {
