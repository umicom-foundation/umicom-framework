/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/qt6/notification_qt6.cpp
 *
 * PURPOSE:
 *   Implement the notification qt6 behaviour used by its public contract and
 *   client applications.
 *
 ...
 * applications.
 */
extern "C" const UmiQt6SurfaceDescriptor *umi_qt6_notification_descriptor(void) {
 ...
 * known state.
 */
extern "C" UmiQt6WidgetHandle umi_qt6_notification_create(const UmiQt6RenderRequest *request) {
