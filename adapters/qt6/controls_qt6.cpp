/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/qt6/controls_qt6.cpp
 *
 * PURPOSE:
 *   Implement the controls qt6 behaviour used by its public contract and client
 *   applications.
 *
 ...
 * applications.
 */
extern "C" const UmiQt6SurfaceDescriptor *umi_qt6_controls_descriptor(void) {
 ...
 * state.
 */
extern "C" UmiQt6WidgetHandle umi_qt6_controls_create(const UmiQt6RenderRequest *request) {
