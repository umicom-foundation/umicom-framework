 ...
 *
 * PURPOSE:
 *   Implement the monitor qt6 behaviour used by its public contract and client
 *   applications.
 *
...
/*
 * Provide the qt6 monitor descriptor operation used by this module and its client
 * applications.
 */
...
/*
 * Initialise qt6 monitor from caller-provided values so later operations receive a known
 * state.
 */
