/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/qt6/context_badge_qt6.cpp
 *
 * PURPOSE:
 *   Implement the context badge qt6 behaviour used by its public contract and
 *   client applications.
 *
 ...
 * applications.
 */
extern "C" const UmiQt6SurfaceDescriptor *umi_qt6_context_badge_descriptor(void) {
 ...
 * known state.
 */
extern "C" UmiQt6WidgetHandle umi_qt6_context_badge_create(const UmiQt6RenderRequest *request) {
