/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/gtk4/context_channel_status.c
 *
 * PURPOSE:
 *   Render the context channel status using GTK4 while retaining Framework-owned state.
 *
 ...
 * applications.
 */
GtkWidget *umi_gtk4_context_channel_status_new(const char *title,const char *detail)
{
