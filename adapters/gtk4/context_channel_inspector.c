/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/gtk4/context_channel_inspector.c
 *
 * PURPOSE:
 *   Render the context channel inspector using GTK4 while retaining Framework-owned state.
 *
 ...
 * client applications.
 */
GtkWidget *umi_gtk4_context_channel_inspector_new(const char *title,const char *detail)
{
