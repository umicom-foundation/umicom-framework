...
static const char WORKBENCH_CSS_PANELS[] =
    ".umicom-canvas-title-handle:focus-visible {"
    "  outline: 2px solid @umi_accent; outline-offset: -2px; }"
    "umicom-canvas-panel.canvas-keyboard-edit .umicom-panel-header {"
    "  border-bottom-color: @umi_accent; }"
    ".umicom-canvas-resize-grip:hover { background: alpha(@umi_accent, 0.32); }"
    ...
    ".umicom-panel-header-locked .umicom-panel-action:disabled { opacity: 0.48; }"
    ...
    "  background: @umi_accent_surface; color: @umi_foreground;"
    "}"
    ".umicom-tool-window-flyout { background: @umi_surface; color: @umi_foreground;"
    "  border: 1px solid @umi_border_strong; }"
    ".umicom-tool-rail { background: @umi_surface_raised; }"
    "button.umicom-tool-rail-named-item { min-width: 0; min-height: 0;"
    "  padding: 5px; margin: 0; border: 0; border-radius: 0;"
    "  color: @umi_muted; background: transparent; box-shadow: none; }"
    "button.umicom-tool-rail-named-item:hover { background: @umi_surface_hover;"
    "  color: @umi_foreground; }"
    "button.umicom-tool-rail-named-item:checked { background: @umi_accent_surface;"
    "  color: @umi_foreground; }"
