/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/gtk4/context_channel_history.c
 *
 * PURPOSE:
 *   Render the context channel history using GTK4 while retaining Framework-owned state.
 *
...
GtkWidget *umi_gtk4_context_channel_history_new(const char *title,const char *detail)
{
