...
/* Provide the draw media operation used by this module and its client applications. */
...
/* Provide the draw waveform operation used by this module and its client applications. */
