/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/gtk4/context_channel_toolbar.c
 *
 * PURPOSE:
 *   Render the context channel toolbar using GTK4 while retaining Framework-owned state.
 *
...
GtkWidget *umi_gtk4_context_channel_toolbar_new(const char *title,const char *detail)
{
