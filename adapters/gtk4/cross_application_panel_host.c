/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/gtk4/cross_application_panel_host.c
 *
 * PURPOSE:
 *   Render the cross application panel host using GTK4 while retaining Framework-owned state.
 *
...
GtkWidget *umi_gtk4_cross_application_panel_host_new(const char *title,const char *detail)
{
