/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: adapters/gtk4/context_channel_diagnostics.c
 *
 * PURPOSE:
 *   Render the context channel diagnostics using GTK4 while retaining Framework-owned state.
 *
...
GtkWidget *umi_gtk4_context_channel_diagnostics_new(const char *title,const char *detail)
{
