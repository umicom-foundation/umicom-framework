/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/desktop/control/window_group.c
 * PURPOSE: Implement describe logical window groups for application/workbench coordination.
...
void umi_desktop_window_group_init(UmiDesktopWindowGroupSnapshot *value, const char *id)
{
    ...
    value->api_version = UMI_DESKTOP_WINDOW_GROUP_API_VERSION;
    value->enabled = true;
    value->revision = 1U;
