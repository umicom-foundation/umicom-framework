...
/*
 * Initialise desktop panel contribution from caller-provided values so later operations
...
void umi_desktop_panel_contribution_init(UmiDesktopPanelContributionSnapshot *value, const char *id)
{
    ...
    value->api_version = UMI_DESKTOP_PANEL_CONTRIBUTION_API_VERSION;
    value->enabled = true;
    value->revision = 1U;
    /*
     * Protect caller-owned memory by checking that required state is available before it is
...
/*
 * Check that desktop panel contribution satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the desktop panel contribution set subject operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel contribution set detail operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel contribution set state operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel contribution set priority operation used by this module and
...
/*
 * Provide the desktop panel contribution set enabled operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel contribution same identity operation used by this module and
 * its client applications.
 */
