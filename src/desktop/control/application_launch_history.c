/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/desktop/control/application_launch_history.c
 * PURPOSE: Implement record bounded launch outcomes for diagnostics and operator review.
...
/*
 * Initialise desktop application launch history from caller-provided values so later
...
void umi_desktop_application_launch_history_init(UmiDesktopApplicationLaunchHistorySnapshot *value, const char *id)
{
    ...
    value->api_version = UMI_DESKTOP_APPLICATION_LAUNCH_HISTORY_API_VERSION;
    value->enabled = true;
    value->revision = 1U;
    /*
     * Protect caller-owned memory by checking that required state is available before it is
...
/*
 * Check that desktop application launch history satisfies its contract before another
...
/*
 * Provide the desktop application launch history set subject operation used by this module
...
/*
 * Provide the desktop application launch history set detail operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the desktop application launch history set state operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the desktop application launch history set priority operation used by this
...
/*
 * Provide the desktop application launch history set enabled operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the desktop application launch history same identity operation used by this
 * module and its client applications.
 */
