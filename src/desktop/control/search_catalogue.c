...
/*
 * Initialise desktop search catalogue from caller-provided values so later operations
...
/*
 * Check that desktop search catalogue satisfies its contract before another service relies
 * on it.
 */
...
/*
 * Provide the desktop search catalogue set subject operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search catalogue set detail operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search catalogue set state operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search catalogue set priority operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search catalogue set enabled operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search catalogue same identity operation used by this module and its
 * client applications.
 */
