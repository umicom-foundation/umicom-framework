...
/*
 * Initialise desktop layout clone from caller-provided values so later operations receive
 * a known state.
 */
...
/*
 * Check that desktop layout clone satisfies its contract before another service relies on
 * it.
 */
