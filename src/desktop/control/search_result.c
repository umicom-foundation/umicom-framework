/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/desktop/control/search_result.c
 * PURPOSE: Implement represent provider-neutral global search result metadata.
...
void umi_desktop_search_result_init(UmiDesktopSearchResultSnapshot *value, const char *id)
{
    ...
    value->api_version = UMI_DESKTOP_SEARCH_RESULT_API_VERSION;
    value->enabled = true;
    value->revision = 1U;
