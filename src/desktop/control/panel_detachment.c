/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/desktop/control/panel_detachment.c
 * PURPOSE: Implement describe detach/reattach state while preserving panel identity.
...
/*
 * Initialise desktop panel detachment from caller-provided values so later operations
...
void umi_desktop_panel_detachment_init(UmiDesktopPanelDetachmentSnapshot *value, const char *id)
{
    ...
    value->api_version = UMI_DESKTOP_PANEL_DETACHMENT_API_VERSION;
    value->enabled = true;
    value->revision = 1U;
    /*
     * Protect caller-owned memory by checking that required state is available before it is
...
/*
 * Check that desktop panel detachment satisfies its contract before another service relies
 * on it.
 */
...
/*
 * Provide the desktop panel detachment set subject operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel detachment set detail operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel detachment set state operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel detachment set priority operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel detachment set enabled operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop panel detachment same identity operation used by this module and its
 * client applications.
 */
