/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/desktop/control/application_focus.c
 * PURPOSE: Implement track foreground application focus independently from toolkit widgets.
...
/*
 * Initialise desktop application focus from caller-provided values so later operations
...
void umi_desktop_application_focus_init(UmiDesktopApplicationFocusSnapshot *value, const char *id)
{
    ...
    value->api_version = UMI_DESKTOP_APPLICATION_FOCUS_API_VERSION;
    value->enabled = true;
    value->revision = 1U;
    /*
     * Protect caller-owned memory by checking that required state is available before it is
...
/*
 * Check that desktop application focus satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the desktop application focus set subject operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop application focus set detail operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop application focus set state operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop application focus set priority operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop application focus set enabled operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop application focus same identity operation used by this module and
