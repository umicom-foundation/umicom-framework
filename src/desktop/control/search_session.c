...
/*
 * Initialise desktop search session from caller-provided values so later operations
...
void umi_desktop_search_session_init(UmiDesktopSearchSessionSnapshot *value, const char *id)
{
    ...
    value->api_version = UMI_DESKTOP_SEARCH_SESSION_API_VERSION;
    value->enabled = true;
    value->revision = 1U;
    /*
     * Protect caller-owned memory by checking that required state is available before it is
...
/*
 * Check that desktop search session satisfies its contract before another service relies
 * on it.
 */
...
/*
 * Provide the desktop search session set subject operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search session set detail operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search session set state operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search session set priority operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search session set enabled operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop search session same identity operation used by this module and its
 * client applications.
 */
