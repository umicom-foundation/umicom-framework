...
/*
 * Initialise desktop layout identity from caller-provided values so later operations
...
void umi_desktop_layout_identity_init(UmiDesktopLayoutIdentitySnapshot *value, const char *id)
{
    ...
    value->api_version = UMI_DESKTOP_LAYOUT_IDENTITY_API_VERSION;
    value->enabled = true;
    value->revision = 1U;
    /*
     * Protect caller-owned memory by checking that required state is available before it is
...
/*
 * Check that desktop layout identity satisfies its contract before another service relies
 * on it.
 */
...
/*
 * Provide the desktop layout identity set subject operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop layout identity set detail operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop layout identity set state operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop layout identity set priority operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop layout identity set enabled operation used by this module and its
 * client applications.
 */
...
/*
 * Provide the desktop layout identity same identity operation used by this module and its
 * client applications.
 */
