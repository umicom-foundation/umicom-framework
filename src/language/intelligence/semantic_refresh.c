/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/language/intelligence/semantic_refresh.c
 *
 * PURPOSE:
 *   Implement track semantic-token refresh lifecycle and invalidation.
 *
...
void umi_language_intelligence_semantic_refresh_init(UmiLanguageIntelligenceSemanticRefresh *value, const char *id)
{
    ...
    value->api_version = UMI_LANGUAGE_INTELLIGENCE_SEMANTIC_REFRESH_API_VERSION;
