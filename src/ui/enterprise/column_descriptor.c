...
#include <string.h>
UmiStatus umi_ui_ent_column_descriptor_init(UmiUiEntColumnDescriptor *value){if(!value)return UMI_STATUS_INVALID_ARGUMENT;memset(value,0,sizeof *value);value->column_id[0]='\0';value->label[0]='\0';value->width=0;value->minimum_width=0;value->maximum_width=0;value->sortable=0;value->filterable=0;value->editable=0;value->resizable=0;value->visible=0;value->frozen=0;value->width=120;value->minimum_width=32;value->maximum_width=2048;value->sortable=1;value->filterable=1;value->resizable=1;value->visible=1;return UMI_STATUS_OK;}
