...
static const UmiUiBrandPalette DARK_PALETTE = {
    "#0B1220", "#121C2A", "#1A2636", "#223247", "#0E1724", "#2B3A4D",
    "#41556D", "#F4F7FB", "#A9B6C6", "#4C8ED9", "#1D3855", "#43B581",
    "#E4B04A", "#E56874", "#5B91B8", "#D04B55", "#F4F7FB"};
...
static const UmiUiBrandPalette LIGHT_PALETTE = {
    "#F4F7FA", "#FFFFFF", "#EAF0F6", "#DEE8F2", "#FFFFFF", "#C8D3DF",
    "#9AAABD", "#152235", "#586A7E", "#1E5D93", "#DDECF8", "#247A52",
    "#8A5B0A", "#B32D3A", "#315B78", "#B4363F", "#203247"};
...
static const UmiUiBrandPalette HIGH_CONTRAST_PALETTE = {
    "#000000", "#000000", "#111111", "#222222", "#000000", "#FFFFFF",
    "#FFFFFF", "#FFFFFF", "#E0E0E0", "#FFFF00", "#303000", "#00FF80",
    "#FFFF00", "#FF5F5F", "#FFFFFF", "#FFFF00", "#FFFFFF"};
...
/* Select the canonical palette for a toolkit-neutral surface variant. */
const UmiUiBrandPalette *umi_ui_brand_palette_get(UmiUiBrandSurface surface) {
...
/* Confirm that an application can safely use every required semantic colour. */
UmiStatus umi_ui_brand_palette_validate(const UmiUiBrandPalette *palette) {
  ...
  if (palette == NULL || !palette_colour_is_present(palette->background) ||
      ...
      !palette_colour_is_present(palette->editor) || !palette_colour_is_present(palette->border) ||
      ...
      !palette_colour_is_present(palette->warning) || !palette_colour_is_present(palette->danger) ||
