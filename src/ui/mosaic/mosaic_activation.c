...
/*
 * Initialise ui mosaic mosaic activation from caller-provided values so later operations
...
/*
 * Provide the ui mosaic mosaic activation place operation used by this module and its
 * client applications.
 */
...
/*
 * Check that ui mosaic mosaic activation satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic mosaic activation area operation used by this module and its
 * client applications.
 */
