...
/*
 * Initialise ui mosaic context link group from caller-provided values so later operations
...
/*
 * Copy ui mosaic context link group into module-owned storage so callers keep ownership of
 * their input values.
 */
...
/*
 * Check that ui mosaic context link group satisfies its contract before another service
 * relies on it.
 */
