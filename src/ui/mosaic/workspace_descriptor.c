/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/workspace_descriptor.c
 *
 * PURPOSE:
 *   Define toolkit-neutral workspace descriptor contracts for the Framework-owned workbench mosaic platform.
 *
...
/*
 * Initialise ui mosaic workspace descriptor from caller-provided values so later
 * operations receive a known state.
 */
void umi_ui_mosaic_workspace_descriptor_init(UmiUiMosaicWorkspaceDescriptor *value) {
    /*
...
/*
 * Copy ui mosaic workspace descriptor into module-owned storage so callers keep ownership
...
/*
 * Check that ui mosaic workspace descriptor satisfies its contract before another service
 * relies on it.
 */
