/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/dock_transaction.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic dock transaction from caller-provided values so later operations
...
/*
 * Copy ui mosaic dock transaction into module-owned storage so callers keep ownership of
 * their input values.
 */
...
/*
 * Check that ui mosaic dock transaction satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic dock transaction is centre operation used by this module and its
 * client applications.
 */
