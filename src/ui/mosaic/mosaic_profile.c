/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/mosaic_profile.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic mosaic profile from caller-provided values so later operations
...
/*
 * Provide the ui mosaic mosaic profile place operation used by this module and its client
 * applications.
 */
...
/*
 * Check that ui mosaic mosaic profile satisfies its contract before another service relies
 * on it.
 */
...
/*
 * Provide the ui mosaic mosaic profile area operation used by this module and its client
 * applications.
 */
