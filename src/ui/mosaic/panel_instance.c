/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/panel_instance.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic panel instance from caller-provided values so later operations
...
/*
 * Copy ui mosaic panel instance into module-owned storage so callers keep ownership of
 * their input values.
 */
...
/*
 * Check that ui mosaic panel instance satisfies its contract before another service relies
 * on it.
 */
...
/*
 * Provide the ui mosaic panel instance rank operation used by this module and its client
 * applications.
 */
