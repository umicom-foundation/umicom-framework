...
/*
 * Initialise ui mosaic application panel pack from caller-provided values so later
...
/*
 * Provide the ui mosaic application panel pack place operation used by this module and its
 * client applications.
 */
...
/*
 * Check that ui mosaic application panel pack satisfies its contract before another
...
/*
 * Provide the ui mosaic application panel pack area operation used by this module and its
 * client applications.
 */
