...
/*
 * Initialise ui mosaic panel favourite from caller-provided values so later operations
...
/*
 * Copy ui mosaic panel favourite into module-owned storage so callers keep ownership of
 * their input values.
 */
...
/*
 * Check that ui mosaic panel favourite satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic panel favourite rank operation used by this module and its client
 * applications.
 */
