...
/*
 * Initialise ui mosaic panel filter from caller-provided values so later operations
...
/*
 * Copy ui mosaic panel filter into module-owned storage so callers keep ownership of their
 * input values.
 */
...
/*
 * Check that ui mosaic panel filter satisfies its contract before another service relies
 * on it.
 */
...
/*
 * Provide the ui mosaic panel filter rank operation used by this module and its client
 * applications.
 */
