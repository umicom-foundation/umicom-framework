/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/context_route.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic context route from caller-provided values so later operations
...
/*
 * Copy ui mosaic context route into module-owned storage so callers keep ownership of
 * their input values.
 */
...
/*
 * Check that ui mosaic context route satisfies its contract before another service relies
 * on it.
 */
