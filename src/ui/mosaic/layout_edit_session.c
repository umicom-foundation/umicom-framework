/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/layout_edit_session.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic layout edit session from caller-provided values so later operations
...
/*
 * Copy ui mosaic layout edit session into module-owned storage so callers keep ownership
...
/*
 * Check that ui mosaic layout edit session satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic layout edit session touch operation used by this module and its
 * client applications.
 */
