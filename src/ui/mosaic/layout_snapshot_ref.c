/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/layout_snapshot_ref.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic layout snapshot ref from caller-provided values so later operations
...
/*
 * Copy ui mosaic layout snapshot ref into module-owned storage so callers keep ownership
...
/*
 * Check that ui mosaic layout snapshot ref satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic layout snapshot ref touch operation used by this module and its
 * client applications.
 */
