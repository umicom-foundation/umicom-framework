...
/*
 * Initialise ui mosaic panel activation from caller-provided values so later operations
...
/*
 * Copy ui mosaic panel activation into module-owned storage so callers keep ownership of
 * their input values.
 */
...
/*
 * Check that ui mosaic panel activation satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic panel activation rank operation used by this module and its client
 * applications.
 */
