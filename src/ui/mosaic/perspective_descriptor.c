...
/*
 * Initialise ui mosaic perspective descriptor from caller-provided values so later
...
/*
 * Copy ui mosaic perspective descriptor into module-owned storage so callers keep
...
/*
 * Check that ui mosaic perspective descriptor satisfies its contract before another
