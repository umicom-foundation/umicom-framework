/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/dock_history.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic dock history from caller-provided values so later operations
...
/*
 * Copy ui mosaic dock history into module-owned storage so callers keep ownership of their
 * input values.
 */
...
/*
 * Check that ui mosaic dock history satisfies its contract before another service relies
 * on it.
 */
...
/*
 * Provide the ui mosaic dock history is centre operation used by this module and its
 * client applications.
 */
