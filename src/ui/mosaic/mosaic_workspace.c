/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/mosaic_workspace.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic mosaic workspace from caller-provided values so later operations
...
/*
 * Provide the ui mosaic mosaic workspace place operation used by this module and its
 * client applications.
 */
...
/*
 * Check that ui mosaic mosaic workspace satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic mosaic workspace area operation used by this module and its client
 * applications.
 */
