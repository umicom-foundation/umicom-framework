/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/workspace_switch.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic workspace switch from caller-provided values so later operations
...
/*
 * Copy ui mosaic workspace switch into module-owned storage so callers keep ownership of
 * their input values.
 */
...
/*
 * Check that ui mosaic workspace switch satisfies its contract before another service
 * relies on it.
 */
