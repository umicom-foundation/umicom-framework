/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/detached_window.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic detached window from caller-provided values so later operations
...
/*
 * Copy ui mosaic detached window into module-owned storage so callers keep ownership of
 * their input values.
 */
...
/*
 * Check that ui mosaic detached window satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic detached window touch operation used by this module and its client
 * applications.
 */
