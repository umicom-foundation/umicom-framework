/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ui/mosaic/layout_restore_plan.c
 *
 * PURPOSE:
...
/*
 * Initialise ui mosaic layout restore plan from caller-provided values so later operations
...
/*
 * Copy ui mosaic layout restore plan into module-owned storage so callers keep ownership
...
/*
 * Check that ui mosaic layout restore plan satisfies its contract before another service
 * relies on it.
 */
...
/*
 * Provide the ui mosaic layout restore plan touch operation used by this module and its
 * client applications.
 */
