...
/*
 * Provide the developer workbench build commands operation used by this module and its
 * client applications.
 */
...
/*
 * Return the number of records represented by developer workbench build command without
