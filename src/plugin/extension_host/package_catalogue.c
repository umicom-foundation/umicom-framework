...
void umi_plugin_extension_host_package_catalogue_init(UmiPluginExtensionHostPackageCatalogue *catalogue) { if (catalogue != NULL) memset(catalogue, 0, sizeof(*catalogue)); }
