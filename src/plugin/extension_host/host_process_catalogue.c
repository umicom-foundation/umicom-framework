...
void umi_plugin_extension_host_host_process_catalogue_init(UmiPluginExtensionHostHostProcessCatalogue *catalogue) { if (catalogue != NULL) memset(catalogue, 0, sizeof(*catalogue)); }
