...
void umi_plugin_extension_host_crash_catalogue_init(UmiPluginExtensionHostCrashCatalogue *catalogue) { if (catalogue != NULL) memset(catalogue, 0, sizeof(*catalogue)); }
