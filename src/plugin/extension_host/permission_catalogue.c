...
void umi_plugin_extension_host_permission_catalogue_init(UmiPluginExtensionHostPermissionCatalogue *catalogue) { if (catalogue != NULL) memset(catalogue, 0, sizeof(*catalogue)); }
