/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/strategy_research/backtest/average_loss.c
 *
 * PURPOSE:
 *   Apply the shared Backtest Average Loss research calculation without granting live
