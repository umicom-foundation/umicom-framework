/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/strategy_research/backtest/gross_profit.c
 *
 * PURPOSE:
 *   Apply the shared Backtest Gross Profit research calculation without granting live
