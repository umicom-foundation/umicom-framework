/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/strategy_research/strategy/target_distance.c
 *
 * PURPOSE:
 *   Apply the shared Strategy Target Distance research calculation without granting live
