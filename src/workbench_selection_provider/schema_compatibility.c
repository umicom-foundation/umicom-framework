/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/schema_compatibility.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider schema compatibility record.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderSchemaCompatibility *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_schema_compatibility_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_schema_compatibility_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_schema_compatibility_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_schema_compatibility_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_schema_compatibility_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_schema_compatibility_set_description,
    description)
