/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/cache_key.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider cache key.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderCacheKey *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_cache_key_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_cache_key_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_cache_key_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_cache_key_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_cache_key_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_cache_key_set_description,
    description)
