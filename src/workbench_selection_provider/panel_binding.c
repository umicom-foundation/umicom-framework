/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/panel_binding.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider-to-panel binding.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderPanelBinding *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_panel_binding_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_panel_binding_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_panel_binding_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_panel_binding_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_panel_binding_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_panel_binding_set_description,
    description)
