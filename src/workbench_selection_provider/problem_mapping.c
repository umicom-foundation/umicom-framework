/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/problem_mapping.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the problem model-to-selection mapping.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderProblemMapping *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_problem_mapping_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_problem_mapping_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_problem_mapping_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_problem_mapping_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_problem_mapping_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_problem_mapping_set_description,
    description)
