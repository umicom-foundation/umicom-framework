/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/history_entry.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider history entry.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderHistoryEntry *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_history_entry_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_history_entry_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_history_entry_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_history_entry_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_history_entry_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_history_entry_set_description,
    description)
