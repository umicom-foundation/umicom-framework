/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/field_rule.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the structured field rule.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderFieldRule *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_rule_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_rule_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_rule_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_rule_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_rule_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_rule_set_description,
    description)
