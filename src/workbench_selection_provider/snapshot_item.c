/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/snapshot_item.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider snapshot item.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderSnapshotItem *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_snapshot_item_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_snapshot_item_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_snapshot_item_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_snapshot_item_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_snapshot_item_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_snapshot_item_set_description,
    description)
