/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/presentation_record.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider presentation record.
 *
...
/*
 * Initialise workbench selection provider presentation record from caller-provided values
...
/*
 * Check that workbench selection provider presentation record satisfies its contract
...
UmiStatus fn(UmiWorkbenchSelectionProviderPresentationRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_presentation_record_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_presentation_record_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_presentation_record_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_presentation_record_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_presentation_record_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_presentation_record_set_description,
    description)

#undef UMI_PROVIDER_SETTER

/*
 * Provide the workbench selection provider presentation record hash operation used by this
...
/*
 * Provide the workbench selection provider presentation record touch operation used by
