/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/selection_state.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider selection runtime state.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderSelectionState *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_selection_state_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_selection_state_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_selection_state_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_selection_state_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_selection_state_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_selection_state_set_description,
    description)
