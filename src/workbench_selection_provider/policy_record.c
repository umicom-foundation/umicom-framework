/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/policy_record.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider policy record.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderPolicyRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_policy_record_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_policy_record_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_policy_record_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_policy_record_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_policy_record_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_policy_record_set_description,
    description)
