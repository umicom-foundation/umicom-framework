/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/account_mapping.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the account model-to-selection mapping.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderAccountMapping *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_account_mapping_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_account_mapping_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_account_mapping_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_account_mapping_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_account_mapping_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_account_mapping_set_description,
    description)
