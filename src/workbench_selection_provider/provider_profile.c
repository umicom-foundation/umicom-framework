/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/provider_profile.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the provider profile.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderProviderProfile *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_provider_profile_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_provider_profile_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_provider_profile_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_provider_profile_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_provider_profile_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_provider_profile_set_description,
    description)
