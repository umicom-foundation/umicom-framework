/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection_provider/field_requirement.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the structured field requirement.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderFieldRequirement *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_requirement_set_provider,
    provider_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_requirement_set_source,
    source_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_requirement_set_subject,
    subject_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_requirement_set_related,
    related_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_requirement_set_group,
    group_id)
UMI_PROVIDER_SETTER(
    umi_workbench_selection_provider_field_requirement_set_description,
    description)
