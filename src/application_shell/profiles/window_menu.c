/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/application_shell/profiles/window_menu.c
 *
 * PURPOSE:
 *   Define the Framework-owned Window Menu contribution set. Applications render
...
static const UmiApplicationShellContribution CONTRIBUTIONS[] = {
    {
        ...
        .contribution_id = "umicom.shell.window-menu.root",
        .title = "Window",
        .description = "Top-level Window menu.",
        .command_id = "",
        .component_id = "",
        .group_id = "menu-bar",
        .icon_id = "",
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.window-menu.new-window",
        .title = "New Window",
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.window-menu.split-right",
        .title = "Split Right",
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.window-menu.split-down",
        .title = "Split Down",
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.window-menu.float",
        .title = "Float Panel",
        .description = "Float Panel",
        .command_id = "window.float",
        .component_id = "",
        .group_id = "dock",
        .icon_id = "",
        .context_key = "",
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.window-menu.layout-save",
        .title = "Save Layout",
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.window-menu.layout-restore",
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.window-menu.layout-manager",
...
const UmiApplicationShellProfileDefinition *umi_application_shell_profile_window_menu(void)
{
    static const UmiApplicationShellProfileDefinition profile = {
        ...
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .profile_id = "umicom.shell.profile.window-menu",
        .title = "Window Menu",
        .description = "Reusable Framework-owned Window Menu contributions for thin applications.",
