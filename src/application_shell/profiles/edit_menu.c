...
static const UmiApplicationShellContribution CONTRIBUTIONS[] = {
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.edit-menu.select-all",
        .title = "Select All",
        .description = "Select the complete source document.",
        .command_id = "edit.select-all",
        .component_id = "", .group_id = "selection", .icon_id = "", .context_key = "",
        .role = UMI_APPLICATION_SHELL_ROLE_MENU_ITEM,
        .region = UMI_APPLICATION_SHELL_REGION_MENU_BAR,
        .order = 230,
        .flags = UMI_APPLICATION_SHELL_VISIBLE | UMI_APPLICATION_SHELL_ENABLED,
    ...
    },
    {
        .structure_size = (uint32_t)sizeof(UmiApplicationShellContribution),
        .api_version = UMI_APPLICATION_SHELL_API_VERSION,
        .contribution_id = "umicom.shell.edit-menu.delete",
        .title = "Delete Selection",
        .description = "Delete the selected source text without changing the clipboard.",
...
/*
 * Provide the application shell profile edit menu operation used by this module and its
 * client applications.
 */
