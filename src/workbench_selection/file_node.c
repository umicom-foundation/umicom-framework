/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/file_node.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the file tree node.
 *
...
UmiStatus fn(UmiWorkbenchSelectionFileNode *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_file_node_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_file_node_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_file_node_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_file_node_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_file_node_set_label, label)
