/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/field_mapping.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the selection field mapping.
 *
...
UmiStatus fn(UmiWorkbenchSelectionFieldMapping *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_field_mapping_set_source, source_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_field_mapping_set_subject, subject_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_field_mapping_set_related, related_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_field_mapping_set_group, group_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_field_mapping_set_description, description)
