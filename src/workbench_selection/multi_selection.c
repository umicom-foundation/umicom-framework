/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/multi_selection.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the multi-selection state.
 *
...
UmiStatus fn(UmiWorkbenchSelectionMultiSelection *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_multi_selection_set_source, source_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_multi_selection_set_subject, subject_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_multi_selection_set_related, related_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_multi_selection_set_group, group_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_multi_selection_set_description, description)
