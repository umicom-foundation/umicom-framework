/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/source_branch.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the structured source-control branch.
 *
...
UmiStatus fn(UmiWorkbenchSelectionSourceBranch *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_source_branch_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_source_branch_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_source_branch_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_source_branch_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_source_branch_set_label, label)
