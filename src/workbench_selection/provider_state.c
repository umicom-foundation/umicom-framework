/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/provider_state.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the selection provider state.
 *
...
UmiStatus fn(UmiWorkbenchSelectionProviderState *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_provider_state_set_source, source_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_provider_state_set_subject, subject_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_provider_state_set_related, related_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_provider_state_set_group, group_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_provider_state_set_description, description)
