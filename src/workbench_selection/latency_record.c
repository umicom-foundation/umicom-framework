/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/latency_record.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the selection latency record.
 *
...
UmiStatus fn(UmiWorkbenchSelectionLatencyRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_latency_record_set_source, source_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_latency_record_set_subject, subject_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_latency_record_set_related, related_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_latency_record_set_group, group_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_latency_record_set_description, description)
