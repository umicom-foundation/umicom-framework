/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/snapshot_record.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the selection snapshot record.
 *
...
UmiStatus fn(UmiWorkbenchSelectionSnapshotRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_snapshot_record_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_snapshot_record_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_snapshot_record_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_snapshot_record_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_snapshot_record_set_label, label)
