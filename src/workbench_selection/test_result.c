/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/test_result.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the structured test result.
 *
...
UmiStatus fn(UmiWorkbenchSelectionTestResult *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_test_result_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_test_result_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_test_result_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_test_result_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_test_result_set_label, label)
