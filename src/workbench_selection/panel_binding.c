/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/panel_binding.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the panel selection binding.
 *
...
UmiStatus fn(UmiWorkbenchSelectionPanelBinding *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_panel_binding_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_panel_binding_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_panel_binding_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_panel_binding_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_panel_binding_set_label, label)
