/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/source_commit.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the structured source-control commit.
 *
...
UmiStatus fn(UmiWorkbenchSelectionSourceCommit *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_source_commit_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_source_commit_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_source_commit_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_source_commit_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_source_commit_set_label, label)
