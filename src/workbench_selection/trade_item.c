/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/trade_item.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the structured trade item.
 *
...
UmiStatus fn(UmiWorkbenchSelectionTradeItem *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_trade_item_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_trade_item_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_trade_item_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_trade_item_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_trade_item_set_label, label)
