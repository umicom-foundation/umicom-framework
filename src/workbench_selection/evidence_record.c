/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/evidence_record.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the selection evidence record.
 *
...
UmiStatus fn(UmiWorkbenchSelectionEvidenceRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_evidence_record_set_source, source_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_evidence_record_set_subject, subject_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_evidence_record_set_related, related_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_evidence_record_set_group, group_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_evidence_record_set_description, description)
