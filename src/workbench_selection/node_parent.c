/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/node_parent.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the structured node parent relationship.
 *
...
UmiStatus fn(UmiWorkbenchSelectionNodeParent *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_node_parent_set_source, source_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_node_parent_set_subject, subject_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_node_parent_set_related, related_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_node_parent_set_group, group_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_node_parent_set_description, description)
