/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/validation_record.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the selection validation record.
 *
...
UmiStatus fn(UmiWorkbenchSelectionValidationRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_validation_record_set_source, source_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_validation_record_set_subject, subject_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_validation_record_set_related, related_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_validation_record_set_group, group_id)
UMI_SELECTION_EXTRA_SETTER(umi_workbench_selection_validation_record_set_description, description)
