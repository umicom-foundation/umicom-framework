/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/rejection_record.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the selection rejection record.
 *
...
UmiStatus fn(UmiWorkbenchSelectionRejectionRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_rejection_record_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_rejection_record_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_rejection_record_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_rejection_record_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_rejection_record_set_label, label)
