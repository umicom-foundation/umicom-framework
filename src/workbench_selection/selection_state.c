/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_selection/selection_state.c
 *
 * PURPOSE:
 *   Implement bounded mutation, validation and hashing for the selection runtime state.
 *
...
UmiStatus fn(UmiWorkbenchSelectionSelectionState *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_SELECTION_SETTER(umi_workbench_selection_selection_state_set_source, source_id)
UMI_SELECTION_SETTER(umi_workbench_selection_selection_state_set_subject, subject_id)
UMI_SELECTION_SETTER(umi_workbench_selection_selection_state_set_secondary, secondary_id)
UMI_SELECTION_SETTER(umi_workbench_selection_selection_state_set_group, group_id)
UMI_SELECTION_SETTER(umi_workbench_selection_selection_state_set_label, label)
