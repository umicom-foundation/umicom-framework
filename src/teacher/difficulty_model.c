 ...
 */
void umi_teacher_difficulty_model_init(UmiTeacherDifficultyModel *rubric) { /* Protect caller-owned memory by checking that required state is available before it is used. */ if(rubric!=NULL) { rubric->correctness_weight=60U;
