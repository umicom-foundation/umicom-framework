/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/repository/inspection/branch_probe.c
 *
 * PURPOSE:
 *   Implement populate the existing branch maintenance model from porcelain-v2 output.
 *
 * ARCHITECTURE:
...
UmiStatus umi_repository_branch_probe_read(
    const UmiRepositoryInspectionContext *context,
    UmiRepositoryBranchStatus *out_value)
{
