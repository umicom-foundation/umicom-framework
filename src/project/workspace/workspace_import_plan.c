/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/project/workspace/workspace_import_plan.c
 *
 * PURPOSE:
 *   Implement the workspace import plan behavior for
 *   Umicom Framework.
 *
 ...
 * MIT
 *---------------------------------------------------------------------------*/
/* Umicom Framework | Workspace Import Plan | MIT */
#include "umicom/project/workspace/workspace_import_plan.h"
#include "internal.h"
#include <string.h>
/*
 * Initialise project workspace workspace import plan from caller-provided values so later
...
/*
 * Add project workspace workspace import plan only after its inputs and available capacity
 * have been checked.
 */
UmiStatus umi_project_workspace_workspace_import_plan_add(UmiProjectWorkspaceWorkspaceImportPlan *value,const char *id,const char *action,bool required) {
    UmiProjectWorkspaceWorkspaceImportPlanStep *s;
    size_t i;
    UmiStatus st;
    /*
     * Protect caller-owned memory by checking that required state is available before it is
...
/*
 * Provide the project workspace workspace import plan complete operation used by this
...
/*
 * Provide the project workspace workspace import plan ready operation used by this module
