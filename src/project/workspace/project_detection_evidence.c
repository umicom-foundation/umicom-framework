...
#include <string.h>
/*
 * Initialise project workspace project detection evidence from caller-provided values so
...
/*
 * Check that project workspace project detection evidence satisfies its contract before
...
/*
 * Provide the project workspace project detection evidence set name operation used by this
...
/*
 * Provide the project workspace project detection evidence set detail operation used by
...
/*
 * Provide the project workspace project detection evidence set state operation used by
 * this module and its client applications.
 */
...
/*
 * Provide the project workspace project detection evidence set metric operation used by
 * this module and its client applications.
 */
...
/*
 * Provide the project workspace project detection evidence same identity operation used by
 * this module and its client applications.
 */
