...
#include <string.h>
/*
 * Initialise project workspace project migration from caller-provided values so later
...
/*
 * Check that project workspace project migration satisfies its contract before another
...
/*
 * Provide the project workspace project migration set name operation used by this module
...
/*
 * Provide the project workspace project migration set detail operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace project migration set state operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace project migration set metric operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace project migration same identity operation used by this
