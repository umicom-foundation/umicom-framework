...
#include <string.h>
/*
 * Initialise project workspace workspace migration plan from caller-provided values so
...
/*
 * Add project workspace workspace migration plan only after its inputs and available
...
/*
 * Provide the project workspace workspace migration plan complete operation used by this
...
/*
 * Provide the project workspace workspace migration plan ready operation used by this
 * module and its client applications.
 */
