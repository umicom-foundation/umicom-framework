...
#include <string.h>
/*
 * Initialise project workspace workspace profile from caller-provided values so later
...
/*
 * Check that project workspace workspace profile satisfies its contract before another
...
/*
 * Provide the project workspace workspace profile set name operation used by this module
...
/*
 * Provide the project workspace workspace profile set detail operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace workspace profile set state operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace workspace profile set metric operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace workspace profile same identity operation used by this
