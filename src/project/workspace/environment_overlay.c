...
#include <string.h>
/*
 * Initialise project workspace environment overlay from caller-provided values so later
...
/*
 * Check that project workspace environment overlay satisfies its contract before another
...
/*
 * Provide the project workspace environment overlay set name operation used by this module
...
/*
 * Provide the project workspace environment overlay set detail operation used by this
...
/*
 * Provide the project workspace environment overlay set state operation used by this
 * module and its client applications.
 */
...
/*
 * Provide the project workspace environment overlay set metric operation used by this
 * module and its client applications.
 */
...
/*
 * Provide the project workspace environment overlay same identity operation used by this
 * module and its client applications.
 */
