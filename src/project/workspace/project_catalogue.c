/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/project/workspace/project_catalogue.c
 *
 * PURPOSE:
 *   Implement the project catalogue behavior for
 *   Umicom Framework.
 *
...
#include <string.h>
/*
 * Initialise project workspace project catalogue from caller-provided values so later
...
/*
 * Provide the project workspace project catalogue contains operation used by this module
...
/*
 * Add project workspace project catalogue only after its inputs and available capacity
 * have been checked.
 */
...
/*
 * Find project workspace project catalogue while leaving the underlying catalogue or model
