...
#include <string.h>
/*
 * Initialise project workspace workspace identity from caller-provided values so later
...
/*
 * Check that project workspace workspace identity satisfies its contract before another
...
/*
 * Provide the project workspace workspace identity set name operation used by this module
...
/*
 * Provide the project workspace workspace identity set detail operation used by this
...
/*
 * Provide the project workspace workspace identity set state operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace workspace identity set metric operation used by this
 * module and its client applications.
 */
...
/*
 * Provide the project workspace workspace identity same identity operation used by this
 * module and its client applications.
 */
