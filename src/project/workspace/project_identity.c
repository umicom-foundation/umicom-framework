...
#include <string.h>
/*
 * Initialise project workspace project identity from caller-provided values so later
...
/*
 * Check that project workspace project identity satisfies its contract before another
...
/*
 * Provide the project workspace project identity set name operation used by this module
...
/*
 * Provide the project workspace project identity set detail operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace project identity set state operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace project identity set metric operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the project workspace project identity same identity operation used by this
