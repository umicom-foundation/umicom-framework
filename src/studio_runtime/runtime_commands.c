...
static const StudioCommandDefinition COMMANDS[] = {
    ...
    {"studio.layout.code-preview", "Code and Live Preview Layout",
     "Place the active editor beside its safe live preview and diagnostics.",
     STUDIO_COMMAND_LAYOUT_APPLY, "umicom.studio.layout.code-preview", 1},
