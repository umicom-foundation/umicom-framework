...
size_t umi_security_catalogue_v2_count(void) { return sizeof(CAPABILITIES) / sizeof(CAPABILITIES[0]); }
const char *umi_security_catalogue_v2_at(size_t index) { return index < umi_security_catalogue_v2_count() ? CAPABILITIES[index] : NULL; }
