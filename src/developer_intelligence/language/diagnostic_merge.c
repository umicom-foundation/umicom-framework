/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_intelligence/language/diagnostic_merge.c
 *
 * PURPOSE:
 *   Apply the shared Diagnostic Merge policy without replacing the canonical
