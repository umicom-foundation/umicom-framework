/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_event/event_record.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and hashing for the normalised event record.
 *
...
/*
 * Initialise workbench context event event record from caller-provided values so later
...
/*
 * Check that workbench context event event record satisfies its contract before another
...
/*
 * Provide the workbench context event event record set source operation used by this
...
/*
 * Provide the workbench context event event record set subject operation used by this
 * module and its client applications.
 */
...
/*
 * Provide the workbench context event event record set group operation used by this module
...
/*
 * Provide the workbench context event event record set label operation used by this module
 * and its client applications.
 */
...
/*
 * Provide the workbench context event event record hash operation used by this module and
...
/*
 * Provide the workbench context event event record touch operation used by this module and
 * its client applications.
 */
