/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/open_tms/dashboard/operations_health.c
 *
 * PURPOSE:
 *   Apply Treasury Operations Health without duplicating canonical finance/treasury state.
 *
