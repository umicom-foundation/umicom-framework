/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/open_tms/dashboard/settlement_health.c
 *
 * PURPOSE:
 *   Apply Settlement Dashboard Health without duplicating canonical finance/treasury state.
 *
    ...
    UmiOpenTmsSnapshot *outSnapshot)
{
    static const UmiOpenTmsPolicy policy = {
        "dashboard.settlement-health",
        "Settlement Dashboard Health",
