/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/encoding_validation.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Encoding Validation document capability.
 *
...
umi_document_capability_encoding_validation(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_ENCODING_VALIDATION,
