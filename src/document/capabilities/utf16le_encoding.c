/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/utf16le_encoding.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Utf16le Encoding document capability.
 *
...
umi_document_capability_utf16le_encoding(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_UTF16LE_ENCODING,
        .title = "Utf16le Encoding",
