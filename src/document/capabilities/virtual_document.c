/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/virtual_document.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Virtual Document document capability.
 *
...
/*
 * Provide the document capability virtual document operation used by this module and its
 * client applications.
 */
...
umi_document_capability_virtual_document(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_VIRTUAL_DOCUMENT,
