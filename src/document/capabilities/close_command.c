/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/close_command.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Close Command document capability.
 *
...
/*
 * Provide the document capability close command operation used by this module and its
 * client applications.
 */
...
umi_document_capability_close_command(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_CLOSE_COMMAND,
        .title = "Close Command",
