/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/webdav_provider.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Webdav Provider document capability.
 *
...
umi_document_capability_webdav_provider(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_WEBDAV_PROVIDER,
        .title = "Webdav Provider",
