/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/merge_resolution.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Merge Resolution document capability.
 *
...
umi_document_capability_merge_resolution(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_MERGE_RESOLUTION,
