/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/recovery_journal.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Recovery Journal document capability.
 *
...
umi_document_capability_recovery_journal(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_RECOVERY_JOURNAL,
