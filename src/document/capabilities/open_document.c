/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/open_document.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Open Document document capability.
 *
...
umi_document_capability_open_document(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_OPEN_DOCUMENT,
        .title = "Open Document",
