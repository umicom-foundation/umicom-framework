/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/open_command.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Open Command document capability.
 *
...
umi_document_capability_open_command(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_OPEN_COMMAND,
        .title = "Open Command",
