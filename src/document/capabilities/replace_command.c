/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/document/capabilities/replace_command.c
 *
 * PURPOSE:
 *   Define authoritative metadata for the Replace Command document capability.
 *
...
umi_document_capability_replace_command(void)
{
    static const UmiDocumentCapabilityDescriptor descriptor = {
        ...
        .capability_id = UMI_DOCUMENT_CAPABILITY_REPLACE_COMMAND,
