/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/trading_workstation/portfolio/margin_utilisation.c
 *
 * PURPOSE:
 *   Apply the shared Margin Utilisation calculation over copied market/workspace
