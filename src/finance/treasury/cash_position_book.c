 ...
 */
void umi_treasury_cash_position_book_init(UmiTreasuryCashPositionBook *registry) { /* Protect caller-owned memory by checking that required state is available before it is used. */ if (registry != NULL) memset(registry,0,sizeof *registry); }
/*
