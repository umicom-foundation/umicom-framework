...
#include <string.h>
/*
 * Copy payments id into module-owned storage so callers keep ownership of their input
 * values.
 */
...
/*
 * Provide the payments currency from code operation used by this module and its client
 * applications.
 */
...
/*
 * Provide the payments currency equal operation used by this module and its client
 * applications.
 */
bool umi_payments_currency_equal(UmiCurrency left,UmiCurrency right) { return memcmp(left.code,right.code,4U)==0; }
/* Provide the payments abs i64 operation used by this module and its client applications. */
int64_t umi_payments_abs_i64(int64_t value) { /* Apply this branch only when its contract condition is satisfied. */ if(value==INT64_MIN) return INT64_MAX; return value<0 ? -value : value; }
