/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_project/languages/typescript.c
 *
 * PURPOSE:
 *   Define the Framework-owned TypeScript language-pack metadata. This is a
...
const UmiDeveloperProjectLanguagePack *umi_developer_project_language_typescript(void)
{
    static const UmiDeveloperProjectLanguagePack pack = {
        ...
        .language_id = "developer.language.typescript",
        .title = "TypeScript",
        .description =
            "Built-in Umicom Framework language pack for TypeScript.",
