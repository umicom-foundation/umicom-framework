/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_project/languages/yaml.c
 *
 * PURPOSE:
 *   Define the Framework-owned YAML language-pack metadata. This is a
...
const UmiDeveloperProjectLanguagePack *umi_developer_project_language_yaml(void)
{
    static const UmiDeveloperProjectLanguagePack pack = {
        ...
        .language_id = "developer.language.yaml",
        .title = "YAML",
        .description =
            "Built-in Umicom Framework language pack for YAML.",
