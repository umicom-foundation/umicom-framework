/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_project/languages/cpp.c
 *
 * PURPOSE:
 *   Define the Framework-owned C++ language-pack metadata. This is a
...
/*
 * Provide the developer project language cpp operation used by this module and its client
 * applications.
 */
const UmiDeveloperProjectLanguagePack *umi_developer_project_language_cpp(void)
{
    static const UmiDeveloperProjectLanguagePack pack = {
        ...
        .language_id = "developer.language.cpp",
        .title = "C++",
        .description =
            "Built-in Umicom Framework language pack for C++.",
