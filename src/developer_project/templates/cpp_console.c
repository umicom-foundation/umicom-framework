/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_project/templates/cpp_console.c
 *
 * PURPOSE:
 *   Define the complete C++ Console Application starter recipe. Generated source remains
...
const UmiDeveloperProjectTemplate *umi_developer_project_template_cpp_console(void)
{
    static const UmiDeveloperProjectTemplate project_template = {
        ...
        .template_id = "developer.template.cpp-console",
        .title = "C++ Console Application",
        .description = "Native C++ console application with CMake/Ninja and tests.",
