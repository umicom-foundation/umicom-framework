/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_project/templates/thin_desktop_application.c
 *
 * PURPOSE:
 *   Define the complete Umicom Thin Desktop Application starter recipe. Generated source remains
...
const UmiDeveloperProjectTemplate *umi_developer_project_template_thin_desktop_application(void)
{
    static const UmiDeveloperProjectTemplate project_template = {
        ...
        .template_id = "developer.template.thin-desktop-application",
        .title = "Umicom Thin Desktop Application",
        .description = "Framework-first GTK4 desktop application that consumes Umicom::Framework.",
