/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_project/templates/integration_worker.c
 *
 * PURPOSE:
 *   Define the complete Umicom Integration Worker starter recipe. Generated source remains
...
static const UmiDeveloperProjectTemplateFile FILES[] = {
    ...
    {
        "src/main.c",
        "/*-----------------------------------------------------------------------------\n * {{APPLICATION_NAME}}\n *\n * Generated from the Umicom Framework project platform.\n * Author: Sammy Hegab\n * Organisation: Umicom Foundation\n * Licence: MIT\n *---------------------------------------------------------------------------*/\n\n#include <stdio.h>\n\nint main(void)\n{\n    /*\n     * Register product-specific workflow endpoints here while retaining\n     * transport, reliability, persistence and observability in Framework.\n     */\n    (void)puts(\"{{APPLICATION_NAME}} integration worker ready\");\n    return 0;\n}\n",
        0,
        0
    },
    {
...
const UmiDeveloperProjectTemplate *umi_developer_project_template_integration_worker(void)
{
    static const UmiDeveloperProjectTemplate project_template = {
        ...
        .template_id = "developer.template.integration-worker",
        .title = "Umicom Integration Worker",
        .description = "Headless Framework-first worker for messaging, workflows and Data Server integration.",
