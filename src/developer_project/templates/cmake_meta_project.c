/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_project/templates/cmake_meta_project.c
 *
 * PURPOSE:
 *   Define the complete CMake Meta Project starter recipe. Generated source remains
...
static const UmiDeveloperProjectTemplateFile FILES[] = {
    {
        "CMakeLists.txt",
        "#-----------------------------------------------------------------------------\n# {{APPLICATION_NAME}}\n# Generated CMake meta project.\n# Author: Sammy Hegab\n# Organisation: Umicom Foundation\n# Licence: MIT\n#-----------------------------------------------------------------------------\ncmake_minimum_required(VERSION 3.24)\nproject({{TARGET_NAME}} LANGUAGES NONE)\n\n# Add project-specific subdirectories here.\n",
        0,
        0
    },
    {
...
const UmiDeveloperProjectTemplate *umi_developer_project_template_cmake_meta_project(void)
{
    static const UmiDeveloperProjectTemplate project_template = {
        ...
        .template_id = "developer.template.cmake-meta-project",
        .title = "CMake Meta Project",
        .description = "CMake-only project for composing native subprojects and dependencies.",
        .kind = UMI_DEVELOPER_PROJECT_META,
        .build_system = UMI_DEVELOPER_PROJECT_BUILD_CMAKE,
        .primary_language_id = "developer.language.cmake",
