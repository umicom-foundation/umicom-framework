/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/panel_state.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the panel state.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourcePanelState *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_panel_state_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_panel_state_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_panel_state_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_panel_state_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_panel_state_set_label, label)
