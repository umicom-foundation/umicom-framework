/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/audit_record.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source audit record.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceAuditRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_audit_record_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_audit_record_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_audit_record_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_audit_record_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_audit_record_set_label, label)
