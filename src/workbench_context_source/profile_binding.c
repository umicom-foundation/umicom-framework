/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/profile_binding.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source profile binding.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceProfileBinding *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_profile_binding_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_profile_binding_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_profile_binding_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_profile_binding_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_profile_binding_set_label, label)
