/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/query.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source query.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceQuery *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_query_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_query_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_query_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_query_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_query_set_label, label)
