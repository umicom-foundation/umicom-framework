/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/source_descriptor.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the live source descriptor.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceSourceDescriptor *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_source_descriptor_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_source_descriptor_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_source_descriptor_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_source_descriptor_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_source_descriptor_set_label, label)
