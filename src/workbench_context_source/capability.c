/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/capability.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source capability.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceCapability *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_capability_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_capability_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_capability_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_capability_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_capability_set_label, label)
