/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/model_binding.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the toolkit-neutral model binding.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceModelBinding *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_model_binding_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_model_binding_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_model_binding_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_model_binding_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_model_binding_set_label, label)
