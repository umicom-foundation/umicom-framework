/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/document_activation.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the document activation snapshot.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceDocumentActivation *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_activation_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_activation_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_activation_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_activation_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_activation_set_label, label)
