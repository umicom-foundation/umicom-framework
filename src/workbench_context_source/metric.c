/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/metric.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source metric.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceMetric *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_metric_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_metric_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_metric_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_metric_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_metric_set_label, label)
