/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/subscription.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source subscription.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceSubscription *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_subscription_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_subscription_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_subscription_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_subscription_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_subscription_set_label, label)
