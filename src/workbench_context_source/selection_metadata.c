/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/selection_metadata.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the selection metadata.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceSelectionMetadata *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_selection_metadata_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_selection_metadata_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_selection_metadata_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_selection_metadata_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_selection_metadata_set_label, label)
