/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/adapter_binding.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the frontend adapter binding.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceAdapterBinding *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_adapter_binding_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_adapter_binding_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_adapter_binding_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_adapter_binding_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_adapter_binding_set_label, label)
