/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/binding.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the live source binding.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceBinding *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_binding_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_binding_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_binding_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_binding_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_binding_set_label, label)
