/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/trace.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source trace.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceTrace *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trace_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trace_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trace_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trace_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trace_set_label, label)
