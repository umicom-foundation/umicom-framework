/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/group_hint.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the context group routing hint.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceGroupHint *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_group_hint_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_group_hint_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_group_hint_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_group_hint_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_group_hint_set_label, label)
