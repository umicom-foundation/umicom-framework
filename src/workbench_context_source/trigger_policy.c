/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/trigger_policy.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the trigger policy.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceTriggerPolicy *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trigger_policy_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trigger_policy_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trigger_policy_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trigger_policy_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_trigger_policy_set_label, label)
