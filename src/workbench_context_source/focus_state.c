/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/focus_state.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the focus state.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceFocusState *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_focus_state_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_focus_state_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_focus_state_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_focus_state_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_focus_state_set_label, label)
