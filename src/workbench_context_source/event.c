/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/event.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source lifecycle event.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceEvent *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_event_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_event_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_event_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_event_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_event_set_label, label)
