/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/duplicate_record.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the duplicate interaction record.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceDuplicateRecord *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_duplicate_record_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_duplicate_record_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_duplicate_record_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_duplicate_record_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_duplicate_record_set_label, label)
