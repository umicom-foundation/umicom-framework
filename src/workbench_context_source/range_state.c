/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/range_state.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the selection range state.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceRangeState *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_range_state_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_range_state_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_range_state_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_range_state_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_range_state_set_label, label)
