/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/terminal_selection.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the terminal selection snapshot.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceTerminalSelection *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_terminal_selection_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_terminal_selection_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_terminal_selection_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_terminal_selection_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_terminal_selection_set_label, label)
