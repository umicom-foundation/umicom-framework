/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/document_state.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the document state.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourceDocumentState *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_state_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_state_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_state_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_state_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_document_state_set_label, label)
