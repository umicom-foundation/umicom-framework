/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/workbench_context_source/permission.c
 *
 * PURPOSE:
 *   Implement validation, bounded mutation and stable hashing for the source permission.
 *
...
UmiStatus function_name(UmiWorkbenchContextSourcePermission *record, const char *value) \
{ \
    UmiStatus status; \
...
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_permission_set_source, source_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_permission_set_panel, panel_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_permission_set_subject, subject_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_permission_set_group, group_id)
UMI_CONTEXT_SOURCE_SETTER(
    umi_workbench_context_source_permission_set_label, label)
