...
/* Provide the has bounded text operation used by this module and its client applications. */
...
/* Check that target satisfies its contract before another service relies on it. */
