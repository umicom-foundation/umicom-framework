...
/* Provide the rad copy text operation used by this module and its client applications. */
...
/* Check that rad id satisfies its contract before another service relies on it. */
