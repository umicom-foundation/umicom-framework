...
void umi_ai_dev_repository_index_state_set_pending(UmiAiDevRepositoryIndexState *value, uint32_t pending) { if (value != NULL) { value->pending = pending; ++value->revision; } }
