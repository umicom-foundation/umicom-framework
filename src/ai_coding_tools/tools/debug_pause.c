/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ai_coding_tools/tools/debug_pause.c
 *
 * PURPOSE:
 *   Pause Debuggee through the persistent DAP runtime. Debuggee control always requires
...
/*
 * Provide the ai coding tool debug pause descriptor operation used by this module and its
 * client applications.
 */
const UmiAiCodingToolDescriptor *umi_ai_coding_tool_debug_pause_descriptor(void)
{
    static const UmiAiCodingToolDescriptor descriptor = {
        .tool_id = "debug.pause",
        .label = "Pause Debuggee",
        .description = "Pause Debuggee through the Framework DAP runtime.",
...
/*
 * Provide the ai coding tool debug pause invoke operation used by this module and its
 * client applications.
 */
UmiStatus umi_ai_coding_tool_debug_pause_invoke(
    ...
    void *user_data)
{
    ...
    return umi_ai_coding_tool_json_status(
        output, output_capacity, UMI_STATUS_OK, "Pause Debuggee completed.");
}
