/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/ai_coding_tools/tools/source_control_stage.c
 *
 * PURPOSE:
...
/*
 * Provide the ai coding tool source control stage descriptor operation used by this module
...
const UmiAiCodingToolDescriptor *umi_ai_coding_tool_source_control_stage_descriptor(void)
{
    static const UmiAiCodingToolDescriptor descriptor = {
        .tool_id = "source-control.stage",
        .label = "Stage Source File",
...
/*
 * Provide the ai coding tool source control stage invoke operation used by this module and
    ...
    void *user_data)
{
    ...
    status = umi_developer_source_control_stage(
