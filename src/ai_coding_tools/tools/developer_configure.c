...
/*
 * Provide the ai coding tool developer configure descriptor operation used by this module
...
/*
 * Provide the ai coding tool developer configure invoke operation used by this module and
