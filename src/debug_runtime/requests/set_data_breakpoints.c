/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/debug_runtime/requests/set_data_breakpoints.c
 *
 * PURPOSE:
 *   Implement the DAP setDataBreakpoints request without shell interpolation.
 *
    ...
    uint64_t *out_sequence)
{
    ...
    return umi_debug_runtime_request_raw(
        adapter, "setDataBreakpoints", arguments, "", out_sequence);
}
