/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_productivity/diagnostic_parsers/gcc.c
 *
 * PURPOSE:
 *   Normalize GCC output into the shared Framework Problems model.
 *
...
const UmiDeveloperDiagnosticParser *umi_developer_diagnostic_parser_gcc(void)
{
    static const UmiDeveloperDiagnosticParser parser = {
        ...
        .parser_id = "developer.parser.gcc",
        .title = "GCC",
        .tool_id = "gcc",
        .priority = 100,
        .parse = parse_line
