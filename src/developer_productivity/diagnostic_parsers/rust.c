/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: src/developer_productivity/diagnostic_parsers/rust.c
 *
 * PURPOSE:
 *   Normalize Rust output into the shared Framework Problems model.
 *
...
const UmiDeveloperDiagnosticParser *umi_developer_diagnostic_parser_rust(void)
{
    static const UmiDeveloperDiagnosticParser parser = {
        ...
        .parser_id = "developer.parser.rust",
        .title = "Rust",
        .tool_id = "rust",
        .priority = 100,
        .parse = parse_line
