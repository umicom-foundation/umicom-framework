/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/desktop/control/panel_catalogue.h
 *
 * PURPOSE:
 *   Describe catalogue state for Framework-owned and application-contributed panels.
 *
 * ARCHITECTURE:
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DESKTOP_CONTROL_PANEL_CATALOGUE_H
#define UMICOM_DESKTOP_CONTROL_PANEL_CATALOGUE_H
...
#define UMI_DESKTOP_PANEL_CATALOGUE_API_VERSION 1U

/**
 * Represent the desktop panel catalogue snapshot data shared with callers of this public
 * contract.
 */
typedef struct UmiDesktopPanelCatalogueSnapshot {
    ...
    uint64_t revision;
    bool enabled;
} UmiDesktopPanelCatalogueSnapshot;
