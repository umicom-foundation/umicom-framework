/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/desktop/control/search_source.h
 *
 * PURPOSE:
 *   Describe a searchable Framework/application source and its availability.
 *
 * ARCHITECTURE:
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DESKTOP_CONTROL_SEARCH_SOURCE_H
#define UMICOM_DESKTOP_CONTROL_SEARCH_SOURCE_H
...
#define UMI_DESKTOP_SEARCH_SOURCE_API_VERSION 1U

/**
 * Represent the desktop search source snapshot data shared with callers of this public
 * contract.
 */
typedef struct UmiDesktopSearchSourceSnapshot {
    ...
    uint64_t revision;
    bool enabled;
} UmiDesktopSearchSourceSnapshot;
