/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/desktop/control/panel_identity.h
 *
 * PURPOSE:
 *   Provide stable panel identity metadata across layouts and application restarts.
 *
 * ARCHITECTURE:
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DESKTOP_CONTROL_PANEL_IDENTITY_H
#define UMICOM_DESKTOP_CONTROL_PANEL_IDENTITY_H
...
#define UMI_DESKTOP_PANEL_IDENTITY_API_VERSION 1U

/**
 * Represent the desktop panel identity snapshot data shared with callers of this public
 * contract.
 */
typedef struct UmiDesktopPanelIdentitySnapshot {
    ...
    uint64_t revision;
    bool enabled;
} UmiDesktopPanelIdentitySnapshot;
