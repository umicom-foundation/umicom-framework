/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/desktop/control/command_source.h
 *
 * PURPOSE:
 *   Describe a Framework-owned global command provider.
 *
 * ARCHITECTURE:
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DESKTOP_CONTROL_COMMAND_SOURCE_H
#define UMICOM_DESKTOP_CONTROL_COMMAND_SOURCE_H
...
#define UMI_DESKTOP_COMMAND_SOURCE_API_VERSION 1U

/**
 * Represent the desktop command source snapshot data shared with callers of this public
 * contract.
 */
typedef struct UmiDesktopCommandSourceSnapshot {
    ...
    uint64_t revision;
    bool enabled;
} UmiDesktopCommandSourceSnapshot;
