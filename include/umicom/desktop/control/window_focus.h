/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/desktop/control/window_focus.h
 *
 * PURPOSE:
 *   Track active-window state without owning native window handles.
 *
 * ARCHITECTURE:
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DESKTOP_CONTROL_WINDOW_FOCUS_H
#define UMICOM_DESKTOP_CONTROL_WINDOW_FOCUS_H
...
#define UMI_DESKTOP_WINDOW_FOCUS_API_VERSION 1U

/**
 * Represent the desktop window focus snapshot data shared with callers of this public
 * contract.
 */
typedef struct UmiDesktopWindowFocusSnapshot {
