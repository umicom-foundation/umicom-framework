/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/desktop/control/panel_filter.h
 *
 * PURPOSE:
 *   Store application/category filtering policy for the component and panel palette.
 *
 * ARCHITECTURE:
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DESKTOP_CONTROL_PANEL_FILTER_H
#define UMICOM_DESKTOP_CONTROL_PANEL_FILTER_H
...
#define UMI_DESKTOP_PANEL_FILTER_API_VERSION 1U

/**
 * Represent the desktop panel filter snapshot data shared with callers of this public
 * contract.
 */
typedef struct UmiDesktopPanelFilterSnapshot {
