/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/desktop/control/application_pin_store.h
 *
 * PURPOSE:
 *   Persist pin/unpin intent for applications without moving taskbar ownership into an application.
 *
 * ARCHITECTURE:
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DESKTOP_CONTROL_APPLICATION_PIN_STORE_H
#define UMICOM_DESKTOP_CONTROL_APPLICATION_PIN_STORE_H
...
#define UMI_DESKTOP_APPLICATION_PIN_STORE_API_VERSION 1U

/**
 * Represent the desktop application pin store snapshot data shared with callers of this
 * public contract.
 */
typedef struct UmiDesktopApplicationPinStoreSnapshot {
    ...
    uint64_t revision;
    bool enabled;
} UmiDesktopApplicationPinStoreSnapshot;
