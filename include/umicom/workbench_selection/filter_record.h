...
/**
 * Represent the workbench selection filter record data shared with callers of this public
 * contract.
 */
...
/**
 * Provide the workbench selection filter record set source operation used by this module
...
/**
 * Provide the workbench selection filter record set subject operation used by this module
 * and its client applications.
 */
...
/**
 * Provide the workbench selection filter record set secondary operation used by this
...
/**
 * Provide the workbench selection filter record set group operation used by this module
 * and its client applications.
 */
UmiStatus umi_workbench_selection_filter_record_set_group(
    ...
    const char *group_id);
/**
 * Provide the workbench selection filter record set label operation used by this module
 * and its client applications.
 */
