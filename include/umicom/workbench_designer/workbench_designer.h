/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/workbench_designer/workbench_designer.h
 *
 * PURPOSE:
...
#define UMICOM_WORKBENCH_DESIGNER_WORKBENCH_DESIGNER_H
...
/* The complete public surface is composed by the includes above. */
