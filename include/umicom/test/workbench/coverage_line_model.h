/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/test/workbench/coverage_line_model.h
 *
 * PURPOSE:
 *   Model coverage line model state for the Framework-owned production Test/Quality workbench.
 *
 * ARCHITECTURE:
 ...
 * Licence: MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_TEST_WORKBENCH_COVERAGE_LINE_MODEL_H
#define UMICOM_TEST_WORKBENCH_COVERAGE_LINE_MODEL_H
