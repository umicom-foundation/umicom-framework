/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/developer_project/languages/javascript.h
 *
 * PURPOSE:
 *   Publish the built-in JavaScript language pack for project models, generation,
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DEVELOPER_PROJECT_LANGUAGE_JAVASCRIPT_H
#define UMICOM_DEVELOPER_PROJECT_LANGUAGE_JAVASCRIPT_H
