/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/developer_project/languages/bash.h
 *
 * PURPOSE:
 *   Publish the built-in Bash language pack for project models, generation,
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DEVELOPER_PROJECT_LANGUAGE_BASH_H
#define UMICOM_DEVELOPER_PROJECT_LANGUAGE_BASH_H
