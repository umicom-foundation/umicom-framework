/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/developer_project/languages/cpython.h
 *
 * PURPOSE:
 *   Publish the built-in CPython language pack for project models, generation,
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DEVELOPER_PROJECT_LANGUAGE_CPYTHON_H
#define UMICOM_DEVELOPER_PROJECT_LANGUAGE_CPYTHON_H
