...
/**
 * List the named ui component event kind values accepted by this public contract.
 */
...
/**
 * Represent the ui component event data shared with callers of this public contract.
 */
