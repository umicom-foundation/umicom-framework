...
#endif
/**
 * List the named workbench context host health state values accepted by this public
 * contract.
 */
...
/**
 * Represent the workbench context host health data shared with callers of this public
 * contract.
 */
