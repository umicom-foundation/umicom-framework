 ...
 *
 * PURPOSE:
 *   Publish the public project catalogue contract for reusable Umicom applications.
 *
...
#endif
/**
 * Represent the project workspace project catalogue data shared with callers of this
 * public contract.
 */
