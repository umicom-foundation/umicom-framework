 ...
 *
 * PURPOSE:
 *   Publish the public cmake configure model contract for reusable Umicom applications.
 *
...
#endif
/**
 * Represent the project workspace cmake configure model data shared with callers of this
 * public contract.
 */
