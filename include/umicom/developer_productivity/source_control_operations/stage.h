/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/developer_productivity/source_control_operations/stage.h
 *
 * PURPOSE:
 *   Publish metadata for the Stage source-control operation.
 *
 ...
 * MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DEVELOPER_SOURCE_CONTROL_OPERATION_STAGE_H
#define UMICOM_DEVELOPER_SOURCE_CONTROL_OPERATION_STAGE_H
