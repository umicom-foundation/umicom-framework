...
/**
 * Represent the workbench context source ai selection data shared with callers of this
 * public contract.
 */
...
/**
 * Provide the workbench context source ai selection set source operation used by this
...
/**
 * Provide the workbench context source ai selection set panel operation used by this
 * module and its client applications.
 */
UmiStatus umi_workbench_context_source_ai_selection_set_panel(
    ...
    const char *panel_id);
/**
 * Provide the workbench context source ai selection set subject operation used by this
 * module and its client applications.
 */
...
/**
 * Provide the workbench context source ai selection set group operation used by this
 * module and its client applications.
 */
UmiStatus umi_workbench_context_source_ai_selection_set_group(
    ...
    const char *group_id);
/**
 * Provide the workbench context source ai selection set label operation used by this
 * module and its client applications.
 */
