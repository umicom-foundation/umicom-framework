...
/**
 * Represent the workbench selection provider dedupe record data shared with callers of
...
/**
 * Provide the workbench selection provider dedupe record set provider operation used by
...
/**
 * Provide the workbench selection provider dedupe record set source operation used by this
...
/**
 * Provide the workbench selection provider dedupe record set subject operation used by
 * this module and its client applications.
 */
...
/**
 * Provide the workbench selection provider dedupe record set related operation used by
 * this module and its client applications.
 */
...
/**
 * Provide the workbench selection provider dedupe record set group operation used by this
 * module and its client applications.
 */
UmiStatus umi_workbench_selection_provider_dedupe_record_set_group(
    ...
    const char *group_id);
/**
 * Provide the workbench selection provider dedupe record set description operation used by
 * this module and its client applications.
 */
