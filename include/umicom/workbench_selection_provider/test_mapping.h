...
/**
 * Represent the workbench selection provider test mapping data shared with callers of this
 * public contract.
 */
...
/**
 * Provide the workbench selection provider test mapping set provider operation used by
...
/**
 * Provide the workbench selection provider test mapping set source operation used by this
...
/**
 * Provide the workbench selection provider test mapping set subject operation used by this
 * module and its client applications.
 */
...
/**
 * Provide the workbench selection provider test mapping set related operation used by this
 * module and its client applications.
 */
...
/**
 * Provide the workbench selection provider test mapping set group operation used by this
 * module and its client applications.
 */
UmiStatus umi_workbench_selection_provider_test_mapping_set_group(
    ...
    const char *group_id);
/**
 * Provide the workbench selection provider test mapping set description operation used by
 * this module and its client applications.
 */
