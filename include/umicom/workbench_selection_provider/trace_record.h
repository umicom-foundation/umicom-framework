...
/**
 * Represent the workbench selection provider trace record data shared with callers of this
 * public contract.
 */
...
/**
 * Provide the workbench selection provider trace record set provider operation used by
...
/**
 * Provide the workbench selection provider trace record set source operation used by this
...
/**
 * Provide the workbench selection provider trace record set subject operation used by this
 * module and its client applications.
 */
...
/**
 * Provide the workbench selection provider trace record set related operation used by this
 * module and its client applications.
 */
...
/**
 * Provide the workbench selection provider trace record set group operation used by this
 * module and its client applications.
 */
UmiStatus umi_workbench_selection_provider_trace_record_set_group(
    ...
    const char *group_id);
/**
 * Provide the workbench selection provider trace record set description operation used by
 * this module and its client applications.
 */
