/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/workbench_selection_provider/remediation_record.h
 *
 * PURPOSE:
 *   Define the reusable provider remediation record contract.
 *
...
#ifndef UMICOM_WORKBENCH_SELECTION_PROVIDER_REMEDIATION_RECORD_H
#define UMICOM_WORKBENCH_SELECTION_PROVIDER_REMEDIATION_RECORD_H
