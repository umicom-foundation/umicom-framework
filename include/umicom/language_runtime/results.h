...
/**
 * Represent the language runtime completion item data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime completion result data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime hover result data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime signature result data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime location list data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime symbol item data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime symbol list data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime diagnostic item data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime diagnostic list data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime code action item data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime code action list data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime text edit list data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime workspace edit item data shared with callers of this
 * public contract.
 */
...
/**
 * Represent the language runtime workspace edit data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime semantic tokens data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime inlay hint data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime inlay hint list data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime folding range data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the language runtime folding range list data shared with callers of this
 * public contract.
 */
...
/**
 * Represent the language runtime initialize result data shared with callers of this public
 * contract.
 */
