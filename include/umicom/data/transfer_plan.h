/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/data/transfer_plan.h
 *
 * PURPOSE:
 *   Publish the public transfer plan contract for reusable Umicom applications.
 *
...
/**
 * Represent the database transfer plan data shared with callers of this public contract.
 */
