/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/data/workbench/workbench.h
 *
 * PURPOSE:
 *   Aggregate the professional Database, SQL and data-modelling workbench API.
 *
 * Created by: Sammy Hegab
 * Organisation: Umicom Foundation
 * Licence: MIT
 *---------------------------------------------------------------------------*/
#ifndef UMICOM_DATA_WORKBENCH_WORKBENCH_H
#define UMICOM_DATA_WORKBENCH_WORKBENCH_H
...
#endif /* UMICOM_DATA_WORKBENCH_WORKBENCH_H */
