...
/**
 * Represent the ct portability contract data shared with callers of this public contract.
 */
...
/**
 * Provide the ct portability satisfied operation used by this module and its client
 * applications.
 */
