/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/diagnostics/diagnostic.h
 *
 * PURPOSE:
...
/**
 * List the named diagnostic kind values accepted by this public contract.
 */
...
/**
 * Represent the diagnostic snapshot data shared with callers of this public contract.
 */
