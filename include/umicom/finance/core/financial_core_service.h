...
typedef struct UmiFinancialCoreService {
  ...
  UmiCounterpartyRegistry counterparties;
  UmiBookRegistry books;
  UmiPortfolioRegistry portfolios;
  UmiAccountRegistry accounts;
  UmiFinancialProductRegistry products;
  UmiTradeRegistry trades;
  uint64_t revision;
  bool ready;
} UmiFinancialCoreService;
