...
#define UMI_APPLICATION_RUNTIME_MAX_PANELS UMI_APPLICATION_EXPERIENCE_MAX_PANELS
#define UMI_APPLICATION_RUNTIME_MAX_LAYOUTS UMI_APPLICATION_EXPERIENCE_MAX_LAYOUTS
#define UMI_APPLICATION_RUNTIME_MAX_FEATURES UMI_APPLICATION_EXPERIENCE_MAX_FEATURES
