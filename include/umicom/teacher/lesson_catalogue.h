...
/**
 * Represent the teacher lesson catalogue entry data shared with callers of this public
 * contract.
 */
...
/**
 * Represent the teacher lesson catalogue data shared with callers of this public contract.
 */
