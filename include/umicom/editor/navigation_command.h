...
typedef enum UmiEditorNavigationCommandKind {
    ...
    UMI_EDITOR_NAVIGATION_COMMAND_SHOW_CALL_HIERARCHY = 13,
    UMI_EDITOR_NAVIGATION_COMMAND_SHOW_INCOMING_CALLS = 14,
    UMI_EDITOR_NAVIGATION_COMMAND_SHOW_OUTGOING_CALLS = 15,
    UMI_EDITOR_NAVIGATION_COMMAND_SHOW_TYPE_HIERARCHY = 16,
    UMI_EDITOR_NAVIGATION_COMMAND_SHOW_SUPERTYPES = 17,
    UMI_EDITOR_NAVIGATION_COMMAND_SHOW_SUBTYPES = 18,
