/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/studio_runtime/test_activation_profile_output.c
 *
 * PURPOSE:
 *   Verify command activation mapping for Output.
 *
...
int main(void)
{
    ...
    assert(profile->rules[0].surface == UMI_STUDIO_SURFACE_OUTPUT);
