/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/ide_integration/test_surface_profile_ai_approvals.c
 *
 * PURPOSE:
 *   Verify the reusable AI Approvals IDE surface profile.
 *
...
int main(void)
{
    ...
    assert(surface != NULL);
    assert(strcmp(surface->surface_id, "umicom.ai-developer.approvals") == 0);
