/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/ide_integration/test_surface_profile_problems.c
 *
 * PURPOSE:
 *   Verify the reusable Problems IDE surface profile.
 *
...
int main(void)
{
    ...
    assert(surface != NULL);
    assert(strcmp(surface->surface_id, "umicom.ide.problems") == 0);
