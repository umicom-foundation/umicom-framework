/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/ide_integration/test_surface_profile_search.c
 *
 * PURPOSE:
 *   Verify the reusable Search IDE surface profile.
 *
...
int main(void)
{
    ...
    assert(surface != NULL);
    assert(strcmp(surface->surface_id, "umicom.ide.search") == 0);
