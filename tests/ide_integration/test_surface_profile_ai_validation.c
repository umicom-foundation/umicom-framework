/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/ide_integration/test_surface_profile_ai_validation.c
 *
 * PURPOSE:
 *   Verify the reusable AI Validation IDE surface profile.
 *
...
int main(void)
{
    ...
    assert(surface != NULL);
    assert(strcmp(surface->surface_id, "umicom.ai-developer.validation") == 0);
