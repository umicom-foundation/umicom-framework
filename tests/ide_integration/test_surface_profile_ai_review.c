/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/ide_integration/test_surface_profile_ai_review.c
 *
 * PURPOSE:
 *   Verify the reusable AI Patch Review IDE surface profile.
 *
...
int main(void)
{
    ...
    assert(surface != NULL);
    assert(strcmp(surface->surface_id, "umicom.ai-developer.patch-review") == 0);
