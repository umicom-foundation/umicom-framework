/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/developer_productivity/test_diagnostic_parser_msvc.c
 *
 * PURPOSE:
 *   Verify the built-in MSVC diagnostic parser recognizes representative
...
int main(void)
{
    ...
    assert(parser->parse(
        "main.c(7,2): error C2143: syntax error",
        &problem,
