/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_accountant.c
 *
 * PURPOSE:
 *   Verify the canonical accountant Framework experience remains valid with its established identity and default layout.
 *
