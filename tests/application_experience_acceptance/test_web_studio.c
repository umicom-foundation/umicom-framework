/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_web_studio.c
 *
 * PURPOSE:
 *   Verify the canonical web studio Framework experience remains valid with its established identity and default layout.
 *
