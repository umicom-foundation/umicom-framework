/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_trader.c
 *
 * PURPOSE:
 *   Verify the canonical trader Framework experience remains valid with its established identity and default layout.
 *
