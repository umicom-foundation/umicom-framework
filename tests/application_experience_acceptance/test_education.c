/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_education.c
 *
 * PURPOSE:
 *   Verify the canonical education Framework experience remains valid with its established identity and default layout.
 *
