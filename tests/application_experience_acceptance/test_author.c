/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_author.c
 *
 * PURPOSE:
 *   Verify the canonical author Framework experience remains valid with its established identity and default layout.
 *
