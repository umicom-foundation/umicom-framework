/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_database_studio.c
 *
 * PURPOSE:
 *   Verify the canonical database studio Framework experience remains valid with its established identity and default layout.
 *
