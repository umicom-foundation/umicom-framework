/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_studio.c
 *
 * PURPOSE:
 *   Verify the canonical studio Framework experience remains valid with its established identity and default layout.
 *
