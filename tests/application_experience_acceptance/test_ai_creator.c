/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_ai_creator.c
 *
 * PURPOSE:
 *   Verify the canonical ai creator Framework experience remains valid with its established identity and default layout.
 *
