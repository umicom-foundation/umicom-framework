/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_desktop.c
 *
 * PURPOSE:
 *   Verify the canonical desktop Framework experience remains valid with its established identity and default layout.
 *
