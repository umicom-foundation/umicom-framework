/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_exchange.c
 *
 * PURPOSE:
 *   Verify the canonical exchange Framework experience remains valid with its established identity and default layout.
 *
