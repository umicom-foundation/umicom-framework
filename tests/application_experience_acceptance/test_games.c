/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_games.c
 *
 * PURPOSE:
 *   Verify the canonical games Framework experience remains valid with its established identity and default layout.
 *
