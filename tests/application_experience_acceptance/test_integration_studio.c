/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_experience_acceptance/test_integration_studio.c
 *
 * PURPOSE:
 *   Verify the canonical integration studio Framework experience remains valid with its established identity and default layout.
 *
...
int test_application_experience_acceptance_integration_studio(void)
{
    ...
    assert(strcmp(
        ...
        "org.umicom.integration-studio") == 0);
