/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/language_profile_acceptance/test_python.c
 *
 * PURPOSE:
 *   Verify the existing python language profile remains registered with its established core capability.
 *
...
int test_language_profile_acceptance_python(void)
{
    ...
    assert(strcmp(profile.id, "python") == 0);
