/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/language_profile_acceptance/test_javascript.c
 *
 * PURPOSE:
 *   Verify the existing javascript language profile remains registered with its established core capability.
 *
...
int test_language_profile_acceptance_javascript(void)
{
    ...
    assert(strcmp(profile.id, "javascript") == 0);
