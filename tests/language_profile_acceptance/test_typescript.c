/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/language_profile_acceptance/test_typescript.c
 *
 * PURPOSE:
 *   Verify the existing typescript language profile remains registered with its established core capability.
 *
...
int test_language_profile_acceptance_typescript(void)
{
    ...
    assert(strcmp(profile.id, "typescript") == 0);
