/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/language_profile_acceptance/test_markdown.c
 *
 * PURPOSE:
 *   Verify the existing markdown language profile remains registered with its established core capability.
 *
