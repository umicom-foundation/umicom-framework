...
{ (void)root; (void)message; ((UmiTestVcsFixture *)instance)->commit_calls++; if (out_id != NULL && capacity >= 8U) (void)snprintf(out_id, capacity, "%s", "abc1234"); return UMI_STATUS_OK; }
