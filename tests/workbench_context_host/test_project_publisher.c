/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/workbench_context_host/test_project_publisher.c
 *
 * PURPOSE:
 *   Verify canonical project publication.
 *
...
int main(void)
{
    ...
    assert(umi_workbench_context_host_publish_project(
        fixture.host, "blue", "test.source", "project-context",
        "project", "repo", "C:/dev/project", "target", "debug", "c", 100U) == UMI_STATUS_OK);
