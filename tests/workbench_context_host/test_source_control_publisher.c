/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/workbench_context_host/test_source_control_publisher.c
 *
 * PURPOSE:
 *   Verify source-control publication enriches project context.
 *
...
int main(void)
{
    ...
    assert(umi_workbench_context_host_publish_source_control(
        fixture.host, "blue", "test.source", "vcs-context",
        "project", "repo", "C:/dev/project", "main", "src/main.c", "modified", 100U) == UMI_STATUS_OK);
