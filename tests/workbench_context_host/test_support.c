...
/*
 * Exercise mask and return a clear result when the behaviour no longer matches its
 * contract.
 */
...
/*
 * Exercise add group and return a clear result when the behaviour no longer matches its
 * contract.
 */
...
/*
 * Exercise add endpoint and return a clear result when the behaviour no longer matches its
 * contract.
 */
