...
int main(void) { UmiPrudentialLiquidityStressResult r; if(umi_pru_liquidity_stress_result_evaluate(&r,1.1,1.0)!=UMI_STATUS_OK)return 1; return r.passed==1&&r.headroom>0.09?0:2; }
