/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_shell/test_profile_source_control.c
 *
 * PURPOSE:
 *   Verify the built-in Source Control profile is valid and installable.
 *
...
int main(void)
{
    ...
    assert(umi_application_shell_registry_find(
        registry,
        "umicom.shell.source-control.source-control",
