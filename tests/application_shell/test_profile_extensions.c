/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_shell/test_profile_extensions.c
 *
 * PURPOSE:
 *   Verify the built-in Extensions profile is valid and installable.
 *
...
int main(void)
{
    ...
    assert(umi_application_shell_registry_find(
        registry,
        "umicom.shell.extensions.extensions",
