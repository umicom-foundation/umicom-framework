/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_shell/test_profile_application_launcher.c
 *
 * PURPOSE:
 *   Verify the built-in Application Launcher profile is valid and installable.
 *
...
int main(void)
{
    ...
    assert(umi_application_shell_registry_find(
        registry,
        "umicom.shell.application-launcher.launcher",
