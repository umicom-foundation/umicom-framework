/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/application_shell/test_profile_build_dashboard.c
 *
 * PURPOSE:
 *   Verify the built-in Build Dashboard profile is valid and installable.
 *
...
int main(void)
{
    ...
    assert(umi_application_shell_registry_find(
        registry,
        "umicom.shell.build-dashboard.dashboard",
