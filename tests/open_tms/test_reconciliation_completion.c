/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/open_tms/test_reconciliation_completion.c
 *
 * PURPOSE:
 *   Verify Treasury Reconciliation Completion Open TMS behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_open_tms_evaluate_reconciliation_completion(&input, &snapshot) == UMI_STATUS_OK);
