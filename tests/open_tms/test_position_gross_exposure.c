/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/open_tms/test_position_gross_exposure.c
 *
 * PURPOSE:
 *   Verify Gross Treasury Exposure Open TMS behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_open_tms_evaluate_position_gross_exposure(&input, &snapshot) == UMI_STATUS_OK);
