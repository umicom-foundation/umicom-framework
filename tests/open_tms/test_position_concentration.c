/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/open_tms/test_position_concentration.c
 *
 * PURPOSE:
 *   Verify Position Concentration Open TMS behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_open_tms_evaluate_position_concentration(&input, &snapshot) == UMI_STATUS_OK);
