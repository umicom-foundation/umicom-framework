/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/open_tms/test_position_net_exposure.c
 *
 * PURPOSE:
 *   Verify Net Treasury Exposure Open TMS behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_open_tms_evaluate_position_net_exposure(&input, &snapshot) == UMI_STATUS_OK);
