/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/open_tms/test_settlement_netting.c
 *
 * PURPOSE:
 *   Verify Settlement Netting Open TMS behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_open_tms_evaluate_settlement_netting(&input, &snapshot) == UMI_STATUS_OK);
