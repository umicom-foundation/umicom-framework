/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/developer_workbench/test_commands_file.c
 *
 * PURPOSE:
 *   Verify all built-in File command definitions are valid and unique
...
int main(void)
{
    ...
    const size_t count = umi_developer_workbench_file_command_count();
    size_t index;
    size_t other;
