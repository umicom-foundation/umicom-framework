/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/developer_workbench/test_commands_debug.c
 *
 * PURPOSE:
 *   Verify all built-in Debug command definitions are valid and unique
...
int main(void)
{
    ...
    const size_t count = umi_developer_workbench_debug_command_count();
    size_t index;
    size_t other;
