/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/developer_workbench/test_commands_source_control.c
 *
 * PURPOSE:
 *   Verify all built-in Source Control command definitions are valid and unique
...
int main(void)
{
    ...
    const size_t count = umi_developer_workbench_source_control_command_count();
    size_t index;
    size_t other;
