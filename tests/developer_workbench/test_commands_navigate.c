/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/developer_workbench/test_commands_navigate.c
 *
 * PURPOSE:
 *   Verify all built-in Navigate command definitions are valid and unique
...
int main(void)
{
    ...
    const size_t count = umi_developer_workbench_navigate_command_count();
    size_t index;
    size_t other;
