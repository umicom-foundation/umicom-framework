/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/ai_coding_runtime/test_validation_profile_python.c
 *
 * PURPOSE:
 *   Verify the reusable python AI coding validation profile.
 *
...
int main(void)
{
    ...
    assert(umi_ai_coding_validation_profile_python(
