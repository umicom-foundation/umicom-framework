/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/ai_coding_runtime/test_validation_profile_npm.c
 *
 * PURPOSE:
 *   Verify the reusable npm AI coding validation profile.
 *
...
int main(void)
{
    ...
    assert(umi_ai_coding_validation_profile_npm(
