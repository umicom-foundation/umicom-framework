/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/broker_connectivity/test_account_reconciliation.c
 *
 * PURPOSE:
 *   Verify Account Reconciliation broker-connectivity behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_broker_connectivity_evaluate_account_reconciliation(&input, &snapshot) == UMI_STATUS_OK);
