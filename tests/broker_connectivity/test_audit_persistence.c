/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/broker_connectivity/test_audit_persistence.c
 *
 * PURPOSE:
 *   Verify Audit Persistence Coverage broker-connectivity behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_broker_connectivity_evaluate_audit_persistence(&input, &snapshot) == UMI_STATUS_OK);
