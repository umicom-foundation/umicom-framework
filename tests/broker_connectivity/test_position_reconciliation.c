/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/broker_connectivity/test_position_reconciliation.c
 *
 * PURPOSE:
 *   Verify Position Reconciliation broker-connectivity behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_broker_connectivity_evaluate_position_reconciliation(&input, &snapshot) == UMI_STATUS_OK);
