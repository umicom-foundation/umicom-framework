/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/broker_connectivity/test_position_concentration.c
 *
 * PURPOSE:
 *   Verify Position Concentration broker-connectivity behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_broker_connectivity_evaluate_position_concentration(&input, &snapshot) == UMI_STATUS_OK);
