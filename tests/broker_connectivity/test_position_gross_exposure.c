/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/broker_connectivity/test_position_gross_exposure.c
 *
 * PURPOSE:
 *   Verify Gross Exposure broker-connectivity behaviour.
 *
...
int main(void)
{
    ...
    assert(umi_broker_connectivity_evaluate_position_gross_exposure(&input, &snapshot) == UMI_STATUS_OK);
