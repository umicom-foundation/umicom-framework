/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_08.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_literal_search();
        if (descriptor == NULL ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_replace();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_NAVIGATION ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_regex_search();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_NAVIGATION ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_incremental_search();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_NAVIGATION ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_go_to_line();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_NAVIGATION ||
