/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_15.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_preview_editor();
        if (descriptor == NULL ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_pinned_editor();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_WORKSPACE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_recent_editors();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_WORKSPACE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_workspace_trust();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_WORKSPACE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_workspace_state();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_WORKSPACE ||
