/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_12.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_whitespace_rendering();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_current_line();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_indent_guides();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_bracket_guides();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_code_folding();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
