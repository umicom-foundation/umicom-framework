/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_13.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_sticky_scroll();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_editor_decoration();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_semantic_highlighting();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_syntax_highlighting();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_inlay_hints();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
