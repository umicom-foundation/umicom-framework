/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_19.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_document_format();
        if (descriptor == NULL ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_document_symbols();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_LANGUAGE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_workspace_symbols();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_LANGUAGE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_semantic_tokens();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_LANGUAGE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_call_hierarchy();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_LANGUAGE ||
