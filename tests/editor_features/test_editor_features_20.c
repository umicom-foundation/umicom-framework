/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_20.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_type_hierarchy();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_inline_completion();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_linked_editing();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_language_status();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_problems_navigation();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
