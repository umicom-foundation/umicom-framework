/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_14.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_code_lens();
        if (descriptor == NULL ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_editor_theme();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_VIEW ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_editor_tab();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_editor_group();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_WORKSPACE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_editor_split();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_WORKSPACE ||
