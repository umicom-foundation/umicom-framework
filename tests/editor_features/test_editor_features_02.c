/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_02.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_document_identity();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_document_metadata();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_document_lifecycle();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_document_loader();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_document_saver();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
