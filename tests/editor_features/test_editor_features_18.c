/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_18.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_hover();
        if (descriptor == NULL ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_signature_help();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_LANGUAGE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_diagnostic_collection();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_LANGUAGE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_quick_fix();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_LANGUAGE ||
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_rename();
        if (descriptor == NULL ||
            descriptor->struct_size != sizeof(*descriptor) ||
            descriptor->api_version != UMI_EDITOR_FEATURE_API_VERSION ||
            descriptor->category != UMI_EDITOR_FEATURE_CATEGORY_LANGUAGE ||
