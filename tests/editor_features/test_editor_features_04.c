/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/editor_features/test_editor_features_04.c
 *
 * PURPOSE:
...
int main(void)
{
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_read_only_regions();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_virtual_document();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_document_conflict();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_edit_operation();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
    ...
    {
        const UmiEditorFeatureDescriptor *descriptor = umi_editor_feature_edit_transaction();
        /*
         * Protect caller-owned memory by checking that required state is available before it is
         * used.
         */
