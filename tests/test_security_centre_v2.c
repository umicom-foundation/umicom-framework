/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: tests/test_security_centre_v2.c
 *
 * PURPOSE:
 *   Implement the test security centre v2 behavior for
 *   Umicom Framework.
 *
...
int main(void)
{
    ...
    assert(umi_security_catalogue_v2_count() == 10U && strstr(umi_security_catalogue_v2_at(0U),"identity-directory") != NULL);
    return 0;
}
