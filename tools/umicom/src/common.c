...
void umi_cli_print_help(void)
{
    (void)puts(
        ...
        "  umicom install [--source PATH] [--preset NAME] [--prefix PATH] [--component NAME]\n"
        ...
        "  umicom repo commit [PATH] (--message MESSAGE | --auto-message) [--dry-run]\n"
        "  umicom repo push [PATH] [--remote NAME] [--branch NAME]\n"
        "  umicom repo publish [PATH] (--message MESSAGE | --auto-message) [push options]\n"
        ...
        "  --auto-message derives a local message from staged path names only.\n"
...
void umi_cli_print_repo_help(void)
{
    (void)puts(
        ...
        "  umicom repo commit [PATH] (-m MESSAGE | --auto-message) [--dry-run]\n"
        "  umicom repo push [PATH] [options]\n"
        "  umicom repo publish [PATH] (--message MESSAGE | --auto-message) [options]\n\n"
        ...
        "  --auto-message            Derive a local message from staged paths\n\n"
        "Familiar aliases:\n"
        "  umicom add -A\n"
        "  umicom status\n"
        "  umicom commit -m \"Describe the change\"\n"
        "  umicom publish --auto-message\n"
        "  umicom push\n\n"
        "Safety:\n"
